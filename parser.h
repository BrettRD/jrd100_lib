...
const uint8_t CMD_GET_QUERY = 0x0d;
const uint8_t CMD_GET_RF_CHANNEL = 0xaa;//-0x56;
const uint8_t CMD_GET_SELECT_PARA = 0x0b;
...
const uint8_t CMD_LOAD_NV_CONFIG = 0x0a;
const uint8_t CMD_SAVE_NV_CONFIG = 0x09;
...
const uint8_t CMD_READ_MODEM_PARA = 0xf1;//-0xf;
const uint8_t CMD_READ_MULTI = 0x27;
const uint8_t CMD_RESTART = 0x19;
const uint8_t CMD_SCAN_JAMMER = 0xf2;//-0xe;
const uint8_t CMD_SCAN_RSSI = 0xf3;//-0xd;
...
const uint8_t CMD_SET_QUERY = 0x0e;
const uint8_t CMD_SET_READER_ENV_MODE = 0xf5;//-0xb;
const uint8_t CMD_SET_REGION = 0x07;
const uint8_t CMD_SET_RF_CHANNEL = 0xab;//-0x55;
const uint8_t CMD_SET_SELECT_PARA = 0x0c;
...
const uint8_t ERROR_CODE_INSUFFICIENT_POWER = 0x0b;
const uint8_t ERROR_CODE_MEM_LOCKED = 0x04;
const uint8_t ERROR_CODE_MEM_OVERRUN = 0x03;
const uint8_t ERROR_CODE_NON_SPEC_ERROR = 0x0f;
const uint8_t ERROR_CODE_OTHER_ERROR = 0x00;
...
const uint8_t FAIL_INVALID_PARA = 0x0e;
...
const uint8_t FAIL_READ_MEMORY_NO_TAG = 0x09;
...
const uint8_t FRAME_TYPE_ANS = 0x01;
const uint8_t FRAME_TYPE_CMD = 0x00;
const uint8_t FRAME_TYPE_INFO = 0x02;

const uint8_t INVENTORY_MODE0 = 0x00;
const uint8_t INVENTORY_MODE1 = 0x01;
const uint8_t INVENTORY_MODE2 = 0x02;

const uint8_t MODULE_HARDWARE_VERSION_FIELD = 0x00;
